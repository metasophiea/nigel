...
// active video (raise colour, then drop colour) - 23.2us
	//there's 51
	out PortC, PixelColourData nop nop swap PixelColourData out PortC, PixelColourData
...
// display byte:	out PortB, PixelColourData
	...
	ld PixelColourData, Z+ nop out PortC, PixelColourData nop nop swap PixelColourData out PortC, PixelColourData 
	ld PixelColourData, Z+ nop out PortC, PixelColourData nop nop swap PixelColourData out PortC, PixelColourData 
	ld PixelColourData, Z+ nop out PortC, PixelColourData nop nop swap PixelColourData out PortC, PixelColourData 
	ld PixelColourData, Z+ nop out PortC, PixelColourData nop nop swap PixelColourData out PortC, PixelColourData 
	ld PixelColourData, Z+ nop out PortC, PixelColourData nop nop swap PixelColourData out PortC, PixelColourData 
	...
	ld PixelColourData, Z+ nop out PortC, PixelColourData nop nop swap PixelColourData out PortC, PixelColourData 
	ld PixelColourData, Z+ nop out PortC, PixelColourData nop nop swap PixelColourData out PortC, PixelColourData 
	ld PixelColourData, Z+ nop out PortC, PixelColourData nop nop swap PixelColourData out PortC, PixelColourData nop nop nop//36

	out PortC, Blank ;extra (to stop last pixel from streching) (Black Frame on right)
	call wait_1us
	call wait_1us
	nop nop nop nop nop
	nop nop nop nop
