...
// display byte:	out PortB, PixelColourData
	...
	ld PixelColourData, Z+ nop out PortB, PixelColourData nop nop swap PixelColourData out PortB, PixelColourData 
	ld PixelColourData, Z+ nop out PortB, PixelColourData nop nop swap PixelColourData out PortB, PixelColourData 
	ld PixelColourData, Z+ nop out PortB, PixelColourData nop nop swap PixelColourData out PortB, PixelColourData nop nop nop//36

	out PortB, Blank ;extra (to stop last pixel from streching) (Black Frame on right)
	call wait_1us
	call wait_1us
	nop nop nop nop nop
	nop nop nop nop
