...
// active video (raise colour, then drop colour) - 21.13us
	//there's 51
	out PortB, PixelColourData nop nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop nop
	...
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop nop nop nop
	out PortB, Blank ;extra (to stop last pixel from streching) (Black Frame)
	nop nop nop nop nop 
	nop nop nop nop nop	
	nop nop nop nop nop 
	nop 
