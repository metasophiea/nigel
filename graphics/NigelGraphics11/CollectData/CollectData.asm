;For when you have to break up the collection (v1)
...
//	0x08F8 + 0x0100 = 0x07F8 = number of collections to be made in total for a frame
//	0x07F8/(number of collections this round) == whole number
...
//Go!
	...
	#include "CollectData/100CollectDataChunks.asm"
	#include "CollectData/100CollectDataChunks.asm"
