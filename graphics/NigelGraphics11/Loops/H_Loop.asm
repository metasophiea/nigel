...
// active video (raise colour, then drop colour) - 23.2us
	//there's 51
	out PortD, PixelColourData nop nop swap PixelColourData out PortD, PixelColourData
...
// display byte:	out PortB, PixelColourData
	...
	ld PixelColourData, Z+ nop out PortD, PixelColourData nop nop swap PixelColourData out PortD, PixelColourData 
	ld PixelColourData, Z+ nop out PortD, PixelColourData nop nop swap PixelColourData out PortD, PixelColourData 
	ld PixelColourData, Z+ nop out PortD, PixelColourData nop nop swap PixelColourData out PortD, PixelColourData 
	ld PixelColourData, Z+ nop out PortD, PixelColourData nop nop swap PixelColourData out PortD, PixelColourData 
	ld PixelColourData, Z+ nop out PortD, PixelColourData nop nop swap PixelColourData out PortD, PixelColourData 
	...
	ld PixelColourData, Z+ nop out PortD, PixelColourData nop nop swap PixelColourData out PortD, PixelColourData 
	ld PixelColourData, Z+ nop out PortD, PixelColourData nop nop swap PixelColourData out PortD, PixelColourData 
	ld PixelColourData, Z+ nop out PortD, PixelColourData nop nop swap PixelColourData out PortD, PixelColourData nop nop nop//36

	out PortD, Blank ;extra (to stop last pixel from streching) (Black Frame on right)
	call wait_1us
	call wait_1us
	nop nop nop nop nop
	nop nop nop nop
