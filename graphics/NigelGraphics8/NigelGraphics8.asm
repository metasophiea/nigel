...
//
// 80*51 NigelPixels results in a 1.568 aspect ratio, with in 4080 NigelPixels, using 2040 bytes
// (that's 80 colums and 51 rows) 
//
...
// Screen_ScanLineNumber (number of vertical dots in a Nigel_Pixel (devide number of H_Loops run, by number of NigelPixel rows))
	.def Screen_ScanLineNumber = R21 ldi R21, 0x0A
...
// Nigel_HorizontalPixelNumber (number of Nigel_Pixels colums in an image)
	.def Nigel_HorizontalPixelNumber = R23 ldi R23, 0x28
// PixelColourData
