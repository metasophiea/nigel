...
// active video (raise colour, then drop colour) - 18us
	//there's 51
	out PortB, PixelColourData nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop
	...
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop
	ld PixelColourData, Z+ out PortB, PixelColourData nop nop nop nop
	out PortB, Blank ;extra (to stop last pixel from streching)
	nop
	nop
